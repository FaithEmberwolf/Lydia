Shader "Hidden/Locked/.poiyomi/Poiyomi 8.0/Poiyomi World/db991710868716a4a97e14dd47422c51"
{
	Properties
	{
 ...
 #define _LIGHTINGMODE_SHADEMAP 
			...
			float4 frag(v2f i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				float4 mainTexture = UNITY_SAMPLE_TEX2D(_MainTex, poiUV(mainUV, float4(10,1,0,0)) + _Time.x * float4(0,0,0,0));
